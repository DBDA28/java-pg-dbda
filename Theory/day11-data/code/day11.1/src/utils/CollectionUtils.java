...
//add a static method to return populated list of vehicles , with sample data to the caller
	public static ArrayList<Vehicle> populateShowroom() {
		...
		vehicles.add(new Vehicle("abc-1236", Color.WHITE, 185699, parse("2023-03-23"), "Honda"));
		...
		vehicles.add(new Vehicle("abc-1237", Color.WHITE, 385678, parse("2023-02-23"), "Honda"));
		vehicles.add(new Vehicle("abc-1231", Color.RED, 855678, parse("2023-01-25"), "Honda"));
		vehicles.add(new Vehicle("abc-1238", Color.WHITE, 815678, parse("2023-02-23"), "Honda"));
		return vehicles;
	}
}
